...
class SelfdriveD(CruiseHelper):
  def __init__(self, CP=None, CP_SP=None):
    ...
    # tjddyd opt-in (carrot DisableDM): DM processes keep running (so driverMonitoringState
    # stays alive and there is no comm issue); we only suppress the DM alerts here and the
    # forced deceleration in controlsd.
